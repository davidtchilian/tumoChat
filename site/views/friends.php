<?php
  ...
  $sql = "SELECT DISTINCT group_id, group_type, group_name FROM friends JOIN isFriend ON isInGroup_group_id = group_id WHERE group_type = 2 AND isInGroup_user_id = ".$user_id ;
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarText">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            <li class="nav-item">
                                <a class="nav-link active btn" aria-current="page" href="creategroup.php" style="color : white">Add Friends</a>
                            </li>
                            <li class="nav-item">
                                <a onClick="notification()" id="infoButton" class="notifications_btn nav-link" style="color : white; cursor: poniter;">Notifications</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <form class="d-flex searchform" role="search">
                            ...
                            <input class="form-control me-2 srch-input" type="search" placeholder="Search group" aria-label="Search" />
                            <button class="btn search">
                                <img src="../assets/images/loupe.png" alt="Rechercher" style="width : 20px; height: 30px; margin-top : 3px" />
                            </button>
                        </form>
                        <a href="../views/page-accueil.php" class="friends-btn">My Groups</a>
